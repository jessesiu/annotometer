					...
					<table cellpadding="0" cellspacing="0" border="0" align="center" width="600" style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif; color: #6f6f6f;">
						...
						<tr>
							<td width="600" bgcolor="#ffffff" style="padding-left:40px;padding-right:40px;line-height:20px;padding-bottom:10px;">
								...
								<p style="color:#626262; font-size:15px; font-weight:200;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;">We have reset your password to <b><?php if (isset($password_unhashed)) echo $password_unhashed; else  echo 'PASSWORD_IS_EMPTY'; ?></b>
								<br/>Please login and change your password <a href="http://www.annotometer.com/site/login" target="_blank" style="color:#006633;">here</a>.</p>
							</td>
						</tr>
						<tr>
							<td height="6" width="600">
